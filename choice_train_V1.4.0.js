(() => {
  const APP_BUILD = Object.freeze({
    ...
    version: '1.4.0',
    release_label: 'V1.4.0',
    channel: 'stable',
    source_file: 'choice_train_V1.4.0.html',
    source_script: 'choice_train_V1.4.0.js',
  ...
  function applyStudentFriendlyMode(){
    document.body.classList.toggle('student-friendly-on', studentFriendlyModeEnabled());
  }
